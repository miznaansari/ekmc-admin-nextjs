...
const AddEmployees = ({ onSuccess, onClose, selectEatry }) => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      const response = await axios.post(
        ...
        {
          ...data,
          photo_proof_id_url: previewImage,
          profile_pic_image_id: previewImage,
          uap_azure_original_image_url: previewImage,
  ...
  const uploadImage = async (file) => {
    ...
    try {
      ...
      const imageUl = response.data.imageUrl || response.data.customUrl;
