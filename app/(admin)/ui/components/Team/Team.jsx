...
const Team = () => {
  ...
  return (
    <Paper sx={{ p: 2, mt: 1 }}>
      ...
      {/* Table Component */}
      <TeamTable setEditData={setEditData} setOpenDrawer={setOpenDrawer} searchTerm={searchTerm} action={action} setAction={setAction} roleFilter={roleFilter} setRoleFilter={setRoleFilter} setStatusFilter={setStatusFilter} statusFilter={statusFilter} page={page} setPage={setPage} />
      <AddEditTeamForm
        open={openDrawer}
