...
const TeamRoleTable = ({ setEditData, setOpenDrawer, searchTerm = "", action, setAction, roleFilter, setRoleFilter, setStatusFilter, statusFilter, page, setPage }) => {
  ...
  const fetchTeam = async () => {
    try {
      ...
      const res = await api.get(`/api/admin/role/v1/roles?${params}`);

      const resp = res.data?.get_data || {};
              ...
              <TableHead>
                <TableRow>
                  ...
                  {[
                    ...
                    { id: "role_description", label: "Role Description" },
