...
const EditRestaurant = ({ menu, setMenu }) => {
  ...
  const menuItems = [
    ...
    { title: "Legal Document", icon: <DocumentAdd24Regular />, path: "DocumentInfo" },
    { title: "Additional Info", icon: <AddSquare24Regular />, path: "AdditionalInfo" },
    { title: "Device", icon: <PhoneMultiple24Regular />, path: "Device" },
  ];
