...
const RestaurantList = () => {
  ...
  if (viewCafeId)
    return <ViewProfile cafe_list_id={viewCafeId} onClose={() => setViewCafeId(null)} />;

  if (editCafe)
    return <EditRestaurantMain cafeId={editCafe.id} onClose={() => setEditCafe(null)} />;
  ...
  return (
    <Paper sx={{ p: 2, mt: 1, pb: isMobile ? 1 : 0 }}>
      ...
      <TableContainer
        ref={tableRef}
        sx={{ maxHeight: innerHeight - (isMobile ? 230 : 230) }}
      >
