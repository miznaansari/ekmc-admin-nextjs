...
const EditConditions= ({condition,onCancel,onSuccess})=>{

    console.log("condition in edit condition- ", condition)
        ...
        const {
                ...
                useEffect(()=>{
                    setValue('title',condition.title)
                    setValue('banner_condition',condition.banner_condition)
                    setValue('value',condition.value)
                    setValue('status',condition.status)
                },[condition])
                ...
                const onSubmit= async(data)=>{
                    ...
                    const payload= {
                        title:data.title,
                        banner_condition:data.banner_condition,
                        status:data.status,
                        value:data.value
                    }
                              ...
                              pb: 1
                                ...
                                <Grid2 container spacing={2}>
                                    ...
                                    <Grid2 xs={12} width={"100%"}>
                                        <Controller
                                            control={control}
                                            name="banner_condition"
                                            render={({ field }) => (
                                                <TextField
                                                    {...field}
                                                    label="Banner Condition"
                                                    variant="outlined"
                                                    fullWidth
                                                    size="small"
                                                    margin="dense"
