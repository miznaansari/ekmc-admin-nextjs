...
const Last7DaysAnalyticsDrawer = ({ open, onClose }) => {
  ...
  const getChartOptions = (color, type = "area") => ({
    chart: {
      height: 180,
      type: type,
      toolbar: {
            ...
            <Grid container spacing={2}>
              ...
              <Grid
                ...
                <Paper sx={{ p: 2, boxShadow: "0px 2px 8px rgba(0,0,0,0.05)", borderRadius: 1 }}>
                  ...
                  <Divider sx={{ mb: 1.5 }} />
                  <Chart
                    options={getChartOptions("#3f51b5", "bar")}
              ...
              <Grid
                ...
                <Paper sx={{ p: 2, boxShadow: "0px 2px 8px rgba(0,0,0,0.05)", borderRadius: 1 }}>
                  ...
                  <Divider sx={{ mb: 1.5 }} />
                  <Chart
                    options={getChartOptions("#00bcd4", "bar")}
              ...
              <Grid
                ...
                <Paper sx={{ p: 2, boxShadow: "0px 2px 8px rgba(0,0,0,0.05)", borderRadius: 1 }}>
                  ...
                  <Divider sx={{ mb: 1.5 }} />
                  <Chart
                    options={getChartOptions("#4caf50", "area")}
              ...
              <Grid
                ...
                <Paper sx={{ p: 2, boxShadow: "0px 2px 8px rgba(0,0,0,0.05)", borderRadius: 1 }}>
                  ...
                  <Divider sx={{ mb: 1.5 }} />
                  <Chart
                    options={getChartOptions("#ff9800", "area")}
                    series={clicksSeries}
                    type="area"
                    height={180}
                  />
