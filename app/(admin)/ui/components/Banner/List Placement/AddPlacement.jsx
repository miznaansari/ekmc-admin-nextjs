...
const AddPlacement= ({onCancel,onSuccess})=>{
        ...
        const {
                ...
                const onSubmit= async(data)=>{
                    ...
                    try{
                        const response= await axios.post(`${baseurl}/api/banner/placement/v1/banner`,payload,{
                            headers:{
                    ...
                    >
                        <Paper sx={{ padding: 1 }}>
                            <Stack direction="row" justifyContent="space-between" alignItems="center">
                                <Typography variant="h5">Add Placement</Typography>
                                <IconButton onClick={()=>{
