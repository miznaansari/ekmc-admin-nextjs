      ...
      <Box sx={{ p: 0, mt: 1 }}>
        <Stack direction={{ xs: "column", sm: "row", md: "row" }} spacing={2}>
          ...
          <Box sx={{ position: "relative",width:'100%' }}>
            ...
            {/* Main Content */}
            {menu === undefined && <GeneralInfo datas={menuData["settings"]} />}
            {menu === "settings" && <GeneralInfo datas={menuData["settings"]} />}
            {menu === "social-info" && <SocialLink datas={menuData["social-info"]} />}
            {menu === "time-price" && <TimeManagement datas={menuData["time-price"]} />}
            {menu === "address-info" && <AddressInfo datas={menuData["address-info"]} />}
            ...
            {menu === "single-food-menu" && <FoodMenu datas={menuData["single-food-menu"]} />}
